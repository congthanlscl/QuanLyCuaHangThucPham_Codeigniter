...
$config['licenseKey']  = 'LCNM8VTW2LFPGQP4F3732VX9P8QDG8NR';
...
define('APP_URL', ($_SERVER['SERVER_PORT'] == 443 ? 'https' : 'http') . "://{$_SERVER['SERVER_NAME']}");
...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => APP_URL.'/plugins/ckfinder/userfiles/',
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
