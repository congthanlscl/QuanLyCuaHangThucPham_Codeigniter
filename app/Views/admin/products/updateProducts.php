...
<div class="col-md-12">
    ...
    <div class="card card-primary">
        ...
        <!-- /.card-header -->
        <!-- form start -->
        <form action="<?=cn('ajaxUpdateProducts')?>" data-redirect="<?=base_url("products")?>" >
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="product_name">Tên sản phẩm</label>
                            <input type="hidden" value="<?=$result->product_id?>" name="product_id" id="product_id" readonly >
                            <input type="text" name="product_name" class="form-control" value="<?=$result->product_name?>" readonly slug-to="product_slug" id="product_name" placeholder="Nhập tên sản phẩm">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="product_slug">Slug</label>
                            <input type="text" name="product_slug" readonly="true" value="<?=$result->product_slug?>" class="form-control" id="product_slug" placeholder="Slug">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" value="<?=$result->price?>" class="form-control" name="price" id="price" placeholder="Nhập giá bán">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" value="<?=$result->purchase_price?>" class="form-control" name="purchase_price" id="purchase_price" placeholder="Nhập giá nhập">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="discount">Giảm giá (%)</label>
                            <input type="number" value="<?=$result->discount?>" class="form-control" name="discount" id="discount" placeholder="Giảm giá">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" class="form-control" cols="10" rows="4" placeholder=""><?=$result->description?></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="category_id" id="category_id">
                                <?php foreach($categories as $value){  ?>
                                    <option <?=($value->category_id == $result->category_id) ? "selected" : ""?> value="<?=$value->category_id?>"><?=$value->category_name?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="unit_id" id="unit_id">
                                <?php foreach($units as $value){  ?>
                                    <option <?=($value->unit_id == $result->unit_id) ? "selected" : ""?> value="<?=$value->unit_id?>"><?=$value->unit_name?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" value="<?=$result->keyword?>" class="form-control tags-input" name="keyword" id="keyword" placeholder="Từ khoá liên quan">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="tag_id" id="tag_id">
                                <?php foreach($tags as $value){  ?>
                                    <option <?=($value->tag_id == $result->tag_id) ? "selected" : ""?> value="<?=$value->tag_id?>"><?=$value->tag_name?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
