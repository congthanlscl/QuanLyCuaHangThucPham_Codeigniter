<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="<?=cn('ajaxAddOrder')?>" data-redirect="<?=base_url("order")?>">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select select2" name="customer" id="customer">
