<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="<?=cn('ajaxUpdateTags')?>" data-redirect="<?=base_url("tags")?>" >
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="tag_name">Tên nhãn</label>
                                <input type="text" name="tag_name" class="form-control" value="<?=$result->tag_name?>" id="tag_name" readonly="true" placeholder="Nhập tên nhãn">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
